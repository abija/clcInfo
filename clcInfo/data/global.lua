...
function mod.Buff_HunterAspect()
	local name, icon

	name, _, icon = UnitBuff("player", "Aspect of the Dragonhawk") if name then return icon end
	name, _, icon = UnitBuff("player", "Aspect of the Viper") if name then return icon end
	name, _, icon = UnitBuff("player", "Aspect of the Pack") if name then return icon end
	name, _, icon = UnitBuff("player", "Aspect of the Cheetah") if name then return icon end
	name, _, icon = UnitBuff("player", "Aspect of the Beast") if name then return icon end

	name, _, icon = UnitBuff("player", "Aspect of the Hawk") if name then return icon end
end
...
--]]
function mod.Item(item, equipped, showWhen)
...
--]]
local icdList = {}
function mod.ICD(spell, icd, alpha1, alpha2, alpha3)
	-- look for the buff
	local i = 1
